package ru.qa.at.utils.web.pagecontext;
...
public class Environment {
    ...
    /**
     * Метод ищет классы, аннотированные "ru.qa.ru.qa.at.utils.web.annotations.Name",
    ...
    public static void initPages(String packageName) {
        pages = new PageCache();
        ru.qa.at.utils.reflections.ReflectionUtil
                .getPagesAnnotatedWith(packageName, ru.qa.at.utils.web.annotations.Name.class)
                .stream()
                .map(it -> {
    ...
    private static String getClassAnnotationValue(Class<?> c) {
        return Arrays
                .stream(c.getAnnotationsByType(ru.qa.at.utils.web.annotations.Name.class))
                .findFirst()
                .map(ru.qa.at.utils.web.annotations.Name::value)
